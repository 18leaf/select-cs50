...
person *create_family(int generations)
{
    ...
    if (child == NULL) //cancel if no space
    {
    ...
    if (generations > 1)
    {
        ...
        child->parents[0] = parent0; //equals mem location of parent 0, 1
        child->parents[1] = parent1;

        // TODO: Randomly assign current person's alleles based on the alleles of their parents
        child->alleles[0] = parent0->alleles[(rand() % 2)]; //either 0 or 1 allele if even = 0 if odd = 1
